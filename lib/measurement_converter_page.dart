...
class _MeasurementConverterPageState extends State<MeasurementConverterPage>
  ...
  void _convertVolume() {
    ...
    try {
      ...
      if (result != null) {
        setState(() {
          _volumeResult = _formatResult(result);
        });
      } else {
        setState(() {
          _volumeResult = 'Cannot convert';
        });
      }
    } catch (e) {
      setState(() {
        _volumeResult = 'Invalid input';
      });
    }
  }
  ...
  void _convertWeight() {
    ...
    try {
      ...
      if (result != null) {
        setState(() {
          _weightResult = _formatResult(result);
        });
      } else {
        setState(() {
          _weightResult = 'Cannot convert';
        });
      }
    } catch (e) {
      setState(() {
        _weightResult = 'Invalid input';
      });
    }
  }
  ...
  void _convertTemperature() {
    ...
    try {
      ...
      if (result != null) {
        setState(() {
          _tempResult = _formatResult(result);
        });
      } else {
        setState(() {
          _tempResult = 'Cannot convert';
        });
      }
    } catch (e) {
      setState(() {
        _tempResult = 'Invalid input';
      });
    }
  }
